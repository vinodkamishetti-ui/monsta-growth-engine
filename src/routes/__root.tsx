  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <span className="text-eyebrow">Lost in the jungle</span>
        <h1 className="mt-4 text-7xl font-black text-foreground">404</h1>
        ...
        <div className="mt-6">
          <Link
            to="/"
            className="inline-flex items-center justify-center rounded-full bg-primary px-6 py-3 text-sm font-bold uppercase tracking-wider text-primary-foreground glow-pink"
          >
            Back home
          </Link>
        </div>
  ...
  head: () => ({
    meta: [
      ...
      { title: "Monsta Media Group — Get Paying Customers On Tap" },
      {
        name: "description",
        content:
          "Monsta Media Group is a bold digital marketing agency for small businesses. Paid ads, SEO, branding, funnels and automations that bring predictable leads.",
      },
      { name: "author", content: "Monsta Media Group" },
